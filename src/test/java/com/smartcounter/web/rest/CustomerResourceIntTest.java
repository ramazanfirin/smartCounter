...
import com.smartcounter.domain.Customer;
import com.smartcounter.repository.CustomerRepository;
...
import static com.smartcounter.web.rest.TestUtil.createFormattingConversionService;
...
public class CustomerResourceIntTest {
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getInsertDate()).isEqualTo(DEFAULT_INSERT_DATE);
    ...
    public void updateCustomer() throws Exception {
        ...
        Customer testCustomer = customerList.get(customerList.size() - 1);
        assertThat(testCustomer.getInsertDate()).isEqualTo(UPDATED_INSERT_DATE);
